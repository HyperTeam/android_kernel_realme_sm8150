...
int set_oppo_display_vendor(const char * display_name) {
	...
	} else if (!strcmp(display_name,"dsi_oppo19696boe_nt36672c_1080_2400_90fps_vid_display")) {
		oppo_display_vendor = OPPO_19696_BOE_DISPLAY_FHD_DSC_VID_PANEL;
		register_device_proc("lcd", "nt36672c", "boe vdo mode");
	} else if (!strcmp(display_name,"dsi_oppo19696jdi_nt36672c_1080_2400_90fps_vid_display")) {
		oppo_display_vendor = OPPO_19696_JDI_DISPLAY_FHD_DSC_VID_PANEL;
